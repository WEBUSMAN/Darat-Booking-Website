            ...
            <Grid container spacing={2} justifyContent="center" sx={{ width: { xl: "90%", lg: "90%", md: "90%", sm: "90%", xs: "100%" }, margin: { xl: "auto", lg: "auto", md: "auto", sm: "auto" } }}>
                <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
                    <Box style={boxStyle}>
                        ...
                        <Box>
                            ...
                            <Box>
                                <Typography sx={{ fontSize: { xl: "30px", lg: "30px", md: "24px", sm: "20px", xs: "18px" }, fontWeight: 600 }}>OPENING HOURS</Typography>
                                <Box sx={{ display: "flex", gap: 3, mt: 3 }}>
                                    <Typography sx={{ fontSize: { xl: "24px", lg: "24px", md: "20px", sm: "16px", xs: "16px" } }} >Saturday to Thursday:</Typography>
                                    <Typography sx={{ fontSize: { xl: "18px", lg: "18px", md: "14px", sm: "12px", xs: "12px" } }}>10:00 am - 10:00 pm</Typography>
                                </Box>
                                <Box sx={{ display: "flex", gap: 3, mt: 3 }}>
                                    <Typography sx={{ fontSize: { xl: "24px", lg: "24px", md: "20px", sm: "16px", xs: "16px" } }} >Friday:</Typography>
                                    <Typography sx={{ fontSize: { xl: "18px", lg: "18px", md: "14px", sm: "12px", xs: "12px" } }}>CLOSED</Typography>
                                </Box>
                            </Box>
                        </Box>
                    </Box>
                ...
                <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
                    ...
                    <Box sx={{ mt: { xl: 0, lg: 0, md: 0, sm: 0, xs: 5 }, padding: 1, }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "flex-end", mt: { xl: 25, lg: 25, md: 23, sm: 20, xs: 10 } }}>
